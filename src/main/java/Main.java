...
//        File file = new File(classLoader.getResource("MoviesJSON").getFile());
        ...
        ArrayList<Movie> movies = objectMapper.readValue(new File("C:\\Users\\kryznar\\Desktop\\Movie.json"),
...
//        scanner.nextLine();
//        if(n == 1){
//            System.out.println("Please provide Actor's name");
//            String name = scanner.nextLine();
//            for(Movie m : movies){
//                for(int i = 0; i < m.getActors().length; i++){
//                    if(m.getActors()[i].equals(name)){
